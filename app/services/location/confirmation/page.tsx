...
export default function ConfirmationLocationPage() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-normal mb-4 uppercase tracking-wider" style={{ fontFamily: "'Playfair Display', serif", letterSpacing: '0.08em', color: '#1a2332' }}>
                Merci pour votre demande de mise en location
              </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Nous avons bien reçu les informations concernant votre projet de location à Marseille.
                </p>
                <p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-8 text-center leading-relaxed">
                Chaque demande de mise en location est étudiée manuellement par l'agence.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                >
                  <div className="animated-card bg-white p-6 rounded-lg shadow-md border border-gray-200" style={{ borderColor: '#1a2332' }}>
                    <p className="text-gray-800 text-center">La cohérence globale de votre projet de location</p>
                  </div>
                </AnimatedContent>
              </div>
              
              <p className="text-lg text-gray-700 text-center leading-relaxed">
                Cette première analyse nous permet de déterminer si une mise en location est pertinente et utile pour votre projet.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-6 text-center leading-relaxed">
                ...
                un bien positionné au loyer du marché se loue dans de bonnes conditions, généralement dans les deux mois.
              </p>
              <p className="text-lg text-gray-700 mb-10 text-center font-semibold">
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex items-center gap-4" style={{ borderColor: '#1a2332' }}>
                  ...
                  <p className="text-gray-800">Ouverts à une mise en location fondée sur la réalité du marché</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p className="text-center">
                  ...
                  nous vous recontacterons dans les <strong>24 à 48h</strong> afin d'échanger plus en détail sur votre bien et votre objectif de location.
                </p>
                <p className="text-center">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center flex-wrap">
                ...
                <Link
                  ...
                  style={{ borderColor: '#1a2332', color: '#1a2332' }}
                >
                  <span className="whitespace-nowrap">Découvrir notre service de Gestion</span>
                  <svg 
                    className="w-5 h-5 opacity-0 group-hover:opacity-100 transform translate-x-[-10px] group-hover:translate-x-0 transition-all duration-300 ease-out flex-shrink-0" 
                    fill="none" 
                    stroke="currentColor" 
