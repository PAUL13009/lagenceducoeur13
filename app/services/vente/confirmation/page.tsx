...
export default function ConfirmationVentePage() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-normal mb-4 uppercase tracking-wider" style={{ fontFamily: "'Playfair Display', serif", letterSpacing: '0.08em', color: '#1a2332' }}>
                Merci pour votre demande de vente
              </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Nous avons bien reçu les informations concernant votre projet de vente à Marseille.
                </p>
                <p>
                  Elles vont nous permettre d'analyser votre bien et votre projet avec sérieux et précision.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-8 text-center leading-relaxed">
                Chaque demande de vente est étudiée manuellement par l'agence.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                >
                  <div className="animated-card bg-white p-6 rounded-lg shadow-md border border-gray-200" style={{ borderColor: '#1a2332' }}>
                    <p className="text-gray-800 text-center">Le contexte du marché</p>
                  </div>
                </AnimatedContent>
                ...
                >
                  <div className="animated-card bg-white p-6 rounded-lg shadow-md border border-gray-200" style={{ borderColor: '#1a2332' }}>
                    <p className="text-gray-800 text-center">La cohérence globale de votre projet de vente</p>
                  </div>
                </AnimatedContent>
              </div>
              
              <p className="text-lg text-gray-700 text-center leading-relaxed">
                Cette première analyse nous permet de déterminer si un accompagnement professionnel est pertinent et utile pour votre projet.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-6 text-center leading-relaxed">
                ...
                un bien positionné au prix du marché se vend dans de bonnes conditions, généralement dans les deux mois.
              </p>
              <p className="text-lg text-gray-700 mb-10 text-center font-semibold">
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex items-center gap-4" style={{ borderColor: '#1a2332' }}>
                  ...
                  <p className="text-gray-800">Ouverts à un accompagnement fondé sur la réalité du marché</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p className="text-center">
                  ...
                  nous vous recontacterons dans les <strong>24 à 48h</strong> afin d'échanger plus en détail sur votre bien et votre objectif de vente.
                </p>
                <p className="text-center">
                  Si ce n'est pas le cas, aucune suite ne sera donnée.<br />
                  Ce fonctionnement nous permet de garantir un accompagnement de qualité à chaque vendeur que nous suivons.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link
                  href="/approche"
                  className="cta-button group bg-transparent border-2 px-8 py-4 rounded-lg font-semibold shadow-lg transition-all flex items-center justify-center gap-2 w-full sm:w-auto"
                  style={{ borderColor: '#1a2332', color: '#1a2332' }}
                >
                  <span>Consulter notre approche</span>
                  <svg 
                ...
                <Link
                  ...
                  style={{ borderColor: '#1a2332', color: '#1a2332' }}
                >
                  <span>En apprendre davantage sur l'agence</span>
                  <svg 
                    className="w-5 h-5 opacity-0 group-hover:opacity-100 transform translate-x-[-10px] group-hover:translate-x-0 transition-all duration-300 ease-out" 
                    fill="none" 
                    stroke="currentColor" 
