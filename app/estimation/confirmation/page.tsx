...
export default function ConfirmationEstimationPage() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Nous avons bien reçu les informations concernant votre bien immobilier à Marseille.
                </p>
                <p>
                  Elles vont nous permettre d'analyser votre projet avec sérieux et précision.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-8 text-center leading-relaxed">
                Chaque demande d'estimation est étudiée manuellement par l'agence.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                >
                  <div className="animated-card bg-white p-6 rounded-lg shadow-md border border-gray-200" style={{ borderColor: '#1a2332' }}>
                    <p className="text-gray-800 text-center">La cohérence globale du projet de vente</p>
                  </div>
                </AnimatedContent>
              </div>
              
              <p className="text-lg text-gray-700 text-center leading-relaxed">
                Cette première analyse nous permet de déterminer si une estimation approfondie est pertinente et utile pour votre projet.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex items-center gap-4" style={{ borderColor: '#1a2332' }}>
                  ...
                  <p className="text-gray-800">Ouverts à une estimation fondée sur la réalité du marché</p>
                </div>
              </div>
            </div>
          </div>
